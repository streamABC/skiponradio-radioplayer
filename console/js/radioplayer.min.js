...
radioplayer.services={unmuteAfterOverlay:!1,heartbeatCounter:0,heartbeatTimeout:null,annoTimeout:null,annoShowing:!1,queuedAnnos:[],saveCookie:function(a,b,c,e){radioplayer.consts.reduced_func||(a=radioplayer.consts.api.init+a,radioplayer.services.getAPI(a+("?"+b+"\x3d"+c),e))},checkCookieConsent:function(a){-1!=document.cookie.indexOf("gdpr-consent")?(radioplayer.consts.show_cookie_consent=!1,radioplayer.services.saveCookie("cookie-consent/s","accepted-cookie-consent","true",a),/(Safari)/.test(user.browser.family)&&
radioplayer.services.showAnno(radioplayer.lang.general.reduced_func_anno)):(radioplayer.checkCookieConsentFailTimeout=setTimeout(function(){radioplayer.consts.show_cookie_consent=!0;radioplayer.consts.reduced_func=!0;radioplayer.services.showCookieConsent()},5E3),radioplayer.services.getAPI(radioplayer.consts.api.init+"cookie-consent/?callback\x3dradioplayer.services.receiveCookieConsentState",a))},receiveCookieConsentState:function(a){clearTimeout(radioplayer.checkCookieConsentFailTimeout);a.accepted&&
-1<document.cookie.indexOf("gdpr-consent")&&(radioplayer.consts.show_cookie_consent=!1,radioplayer.consts.force_reduced_func||/(Safari)/.test(user.browser.family)||(radioplayer.consts.reduced_func=!1));radioplayer.consts.show_cookie_consent?radioplayer.services.showCookieConsent():(radioplayer.services.createExpiringCookie("rp-accepted-cookie-consent",radioplayer.consts.cookie_anno_ttl),radioplayer.consts.show_cookie_anno&&-1==document.cookie.indexOf("rp-seen-cookie-anno")&&radioplayer.services.showCookieAnno())},
initCookie:function(){var a="?callback\x3dradioplayer.services.receiveInit";radioplayer.querystring.stationlistprefix&&(a+="\x26stationlistprefix\x3d"+radioplayer.querystring.stationlistprefix.toLowerCase());radioplayer.consts.cookie_consent_required&&(a+="\x26cookieconsentrequired\x3dtrue");radioplayer.consts.force_reduced_func||radioplayer.consts.show_cookie_consent?radioplayer.services.getAPI(radioplayer.consts.api.init+"init/"+currentStationID+a):radioplayer.services.saveCookie("primed/s","primed",
"true",function(){radioplayer.services.getAPI(radioplayer.consts.api.init+"init/"+currentStationID+a)})},receiveInit:function(a){clearTimeout(radioplayer.initFailTimeout);if(a.dead)return radioplayer.services.analytics.sendEvent("Errors","Static Station",currentStationID,null,null),setTimeout(function(){window.location.href=a.dead.url},100),!1;if(a.redirect)return window.location.href=a.redirect.url,!1;a.primed?radioplayer.consts.show_cookie_consent||(radioplayer.consts.force_reduced_func||/(Safari)/.test(user.browser.family)||
(radioplayer.consts.reduced_func=!1),radioplayer.services.showCookieDependentFeatures()):(radioplayer.consts.reduced_func=!0,radioplayer.services.hideCookieDependentFeatures());if(!radioplayer.consts.reduced_func){var b=a.interstitial&&a.interstitial.seen;!b&&window.initOptions&&window.initOptions.interstitial&&window.initOptions.interstitial.enabled&&(a.interstitial=initOptions.interstitial);if(!b&&a.interstitial&&a.interstitial.url&&""!=a.interstitial.url)return radioplayer.services.saveCookie("interstitial/s",
"interstitial","true"),setTimeout(function(){var b=document.location.href,c=a.interstitial.url,c=c+((0<c.indexOf("?")?"\x26":"?")+"playerUrl\x3d"+encodeURIComponent(b));window.location.href=c},200),!1}a.volume&&""!=a.volume&&(radioplayer.controls.currentVolume=a.volume);if(!radioplayer.consts.reduced_func){b=!1;if(a.presets)for(var c=0;c<a.presets.length;c++){var e=a.presets[c].split(":");radioplayer.settings.presets.push(e[1]);e[1]==currentStationID&&(b=!0)}b?$("#toggle-mystations").addClass("in-mystations").attr("title",
radioplayer.lang.mystations.remove_this).find("span").html(radioplayer.lang.mystations.remove_this):$("#toggle-mystations").attr("title",radioplayer.lang.mystations.add_this).find("span").html(radioplayer.lang.mystations.add_this)}$(radioplayer.services).trigger("gotPresets");a.lastplayed&&""!=a.lastplayed&&(radioplayer.settings.lastplayed=a.lastplayed);a.history&&(radioplayer.settings.history=a.history);$(radioplayer.services).trigger("gotMyStationsAndHistory");a.guid&&(radioplayer.settings.guid=
a.guid);a.stationlistprefix&&(radioplayer.settings.stationlistprefix=a.stationlistprefix);window.initOptions&&window.initOptions.songaction&&window.initOptions.songaction.enabled&&(a.songaction=initOptions.songaction);a.songaction&&(radioplayer.playing.songAction=a.songaction,$(radioplayer.services).trigger("gotSongAction"));a.scripts&&$.each(a.scripts,function(a,b){radioplayer.services.getAPI(b)});radioplayer.controls.isPlaying||(window.audioLive&&(a.overridestream?(window.audioHTML="rtmp"==a.overridestream.type?
window.audioFlash=[{audioType:a.overridestream.type,audioServer:a.overridestream.server,audioEndpoint:a.overridestream.endpoint}]:window.audioFlash=[{audioType:a.overridestream.type,audioUrl:a.overridestream.url}],window.bufferTime=a.overridestream.buffer):"undefined"==typeof window.audioHTML&&a.html5stream&&(b="",b="undefined"!=typeof a.html5stream.type?a.html5stream.type:"http",window.audioHTML=[{audioType:b,audioUrl:a.html5stream.url}])),"undefined"==typeof window.audioHTML&&(window.audioHTML=
[]),radioplayer.emp.setAudioParams(window.audioFlash,window.audioHTML,window.audioLive,window.bufferTime,window.preferHtml5Audio),radioplayer.emp.dataReady());window.initOptions&&window.initOptions.overlay&&window.initOptions.overlay.enabled&&(a.overlay=initOptions.overlay);a.overlay&&radioplayer.services.showOverlay(a.overlay.url,a.overlay.mute);a.announcement?radioplayer.services.showAnno(a.announcement.text):!radioplayer.consts.show_cookie_consent&&radioplayer.consts.reduced_func&&radioplayer.services.showAnno(radioplayer.lang.general.reduced_func_anno)},
showAnno:function(a,b,c){radioplayer.services.annoShowing?radioplayer.services.queueAnno(a):(radioplayer.services.annoShowing=!0,b?($(".radioplayer-anno .anno-text").html(a),$(".radioplayer-anno").animate({top:"0px"},600)):($(".radioplayer").append('\x3cdiv class\x3d"radioplayer-anno"\x3e\x3cdiv class\x3d"anno-text"\x3e'+a+'\x3c/div\x3e\x3ca href\x3d"#" class\x3d"hide-anno"\x3eHide this message\x3c/a\x3e\x3c/div\x3e'),$(".radioplayer-anno").on("click","a.hide-anno",radioplayer.services.hideAnno)),
c||(radioplayer.services.annoTimeout=setTimeout(radioplayer.services.hideAnno,1E4)))},hideAnno:function(){radioplayer.services.annoShowing=!1;clearTimeout(radioplayer.services.annoTimeout);radioplayer.services.saveCookie("announcement/s","announcement","true");$(".radioplayer-anno").animate({top:"-900px"},600,function(){if(0<radioplayer.services.queuedAnnos.length){var a=radioplayer.services.queuedAnnos.shift();radioplayer.services.showAnno(a,!0)}else $(this).remove()})},showCookieAnno:function(){radioplayer.services.createExpiringCookie("rp-seen-cookie-anno",
radioplayer.consts.cookie_anno_ttl);radioplayer.services.showAnno(radioplayer.lang.general.cookie_anno,!1,!0)},queueAnno:function(a){radioplayer.services.queuedAnnos.push(a)},hideCookieConsent:function(){radioplayer.consts.show_cookie_consent=!1;radioplayer.consts.force_reduced_func||/(Safari)/.test(user.browser.family)||(radioplayer.consts.reduced_func=!1);radioplayer.services.createExpiringCookie("rp-accepted-cookie-consent",radioplayer.consts.cookie_anno_ttl);radioplayer.services.createExpiringCookie("gdpr-consent",
radioplayer.consts.cookie_anno_ttl);radioplayer.services.saveCookie("cookie-consent/s","accepted-cookie-consent","true",function(){radioplayer.services.initCookie()});$(".radioplayer-cookie-consent").animate({top:"-900px"},600,function(){$(this).remove();radioplayer.consts.reduced_func?radioplayer.services.showAnno(radioplayer.lang.general.reduced_func_anno):radioplayer.consts.show_cookie_anno&&-1==document.cookie.indexOf("rp-seen-cookie-anno")&&radioplayer.services.showCookieAnno()})},createExpiringCookie:function(a,
b){if(-1==document.cookie.indexOf(a)){var c=new Date;c.setTime(c.getTime()+1E3*b);document.cookie=a+"\x3dyes;max-age\x3d"+b+";expires\x3d"+c.toUTCString()}},showCookieConsent:function(){if(/(Safari)/.test(user.browser.family)&&-1<document.cookie.indexOf("gdpr-consent"))radioplayer.services.showAnno(radioplayer.lang.general.reduced_func_anno);else{var a=window.gdprMessage?radioplayer.lang.general.cookie_consent+window.gdprMessage:radioplayer.lang.general.cookie_consent;$(".radioplayer").append('\x3cdiv class\x3d"radioplayer-cookie-consent" id\x3d"radioplayer-cookie-consent"\x3e\x3ca href\x3d"#" class\x3d"cookie-consent-button"\x3e'+
radioplayer.lang.general.cookie_consent_dismiss+'\x3c/a\x3e\x3cdiv class\x3d"cookie-consent-text" id\x3d"cookie-consent-text"\x3e'+a+"\x3c/div\x3e\x3c/div\x3e");if(440<(document.getElementById("cookie-consent-text").clientHeight||$("#cookie-consent-text").height())){$(".radioplayer-cookie-consent").append('\x3cdiv class\x3d"cookie-consent-arrow"\x3e\x3cdiv class\x3d"cookie-consent-arrow-inner"\x3e\x3c/div\x3e\x3c/div\x3e');$(".cookie-consent-arrow").on("click",function(){$(".cookie-consent-arrow-inner").hasClass("cookie-consent-arrow-inner-reversed")?
$("#cookie-consent-text").animate({scrollTop:0},300):$("#cookie-consent-text").animate({scrollTop:$("#cookie-consent-text").prop("scrollHeight")},500)});var b;$(".cookie-consent-text").on("scroll",function(){$(this)[0].scrollHeight-$(this).scrollTop()==$(this).outerHeight()?b||(b=!0,$(".cookie-consent-arrow-inner").addClass("cookie-consent-arrow-inner-reversed")):b&&(b=!1,$(".cookie-consent-arrow-inner").removeClass("cookie-consent-arrow-inner-reversed"))})}$(".cookie-consent-text").css("max-height",
"440px");$(".cookie-consent-text").css("overflow-y","scroll");$(".cookie-consent-text").css("visibility","visible");$(".radioplayer-cookie-consent").on("click","a.cookie-consent-button",radioplayer.services.hideCookieConsent)}radioplayer.services.hideCookieDependentFeatures()},showOverlay:function(a,b,c){c?$(".radioplayer-body").append('\x3cdiv class\x3d"radioplayer-prerolloverlay"\x3e'+a+"\x3c/div\x3e"):(c=xDomainProxyUrl,a=a+(0<a.indexOf("?")?"\x26":"?")+"rpXDProxy\x3d"+encodeURIComponent(c),$(".radioplayer-body").append('\x3cdiv class\x3d"radioplayer-prerolloverlay"\x3e\x3ciframe src\x3d"'+
a+'"\x3e\x3c/iframe\x3e\x3c/div\x3e'));if(this.unmuteAfterOverlay=b)radioplayer.controls.volumeLocked=!0,radioplayer.consts.is_iOS||radioplayer.consts.is_Android?(radioplayer.controls.isPlaying&&radioplayer.emp.stop(),radioplayer.controls.showPressPlayPrompt()):(radioplayer.controls.savedVolume=radioplayer.controls.currentVolume,radioplayer.emp.ready?radioplayer.emp.setVolume(0):(radioplayer.controls.currentVolume=0,radioplayer.controls.onVolumeUpdate("",{volume:0})))},hideOverlay:function(){radioplayer.services.unmuteAfterOverlay&&
(radioplayer.controls.volumeLocked=!1,radioplayer.consts.is_iOS||radioplayer.consts.is_Android?radioplayer.emp.resume():radioplayer.emp.setVolume(Math.round(radioplayer.controls.savedVolume)));$(".radioplayer-prerolloverlay").remove()},showCookieDependentFeatures:function(){$("#mystations-toggle").removeClass("hidden");$("#toggle-mystations").show();$("#menu-nav-main li").eq(2).removeClass("first");$("#menu-nav-main li").eq(0).show().addClass("first");$("#menu-nav-main li").eq(1).show();radioplayer.consts.show_cookie_dependent_features=
!0},hideCookieDependentFeatures:function(){$("#mystations-toggle").addClass("hidden");$("#toggle-mystations").hide();$("#menu-nav-main li").eq(0).hide().removeClass("first");$("#menu-nav-main li").eq(1).hide();$("#menu-nav-main li").eq(2).addClass("first");radioplayer.consts.show_cookie_dependent_features=!1},xDomainIframeCallback:function(a){"post-preroll-proceed"==jQuery.parseJSON(a).method&&radioplayer.services.hideOverlay()},saveMyStationsOrder:function(){for(var a="",b=0;b<radioplayer.settings.presets.length;b++)a+=
(""==a?"":",")+b+":"+radioplayer.settings.presets[b];radioplayer.services.saveCookie("ms/s","ms",a)},getAPI:function(a,b){$.ajax({url:a,dataType:"script",cache:!1,success:function(){"undefined"!==typeof b&&b()}})},analytics:{loaded:!1,$iframe:null,init:function(){radioplayer.services.analytics.$iframe=$("\x3ciframe /\x3e",{src:radioplayer.consts.iframe.analytics+"?rpid\x3d"+currentStationID+"\x26cType\x3d"+(audioLive?"live":"od\x26odUrl\x3d"+audioFlash[0].audioUrl),name:"GAAnalytics",id:"GAAnalytics",
"class":"crossdomain-iframe",load:function(){window.postMessage&&(radioplayer.services.analytics.loaded=!0,setTimeout(function(){radioplayer.services.analytics.heartbeat()},6E4),window.onbeforeunload=function(a){radioplayer.services.analytics.heartbeat()})}});radioplayer.objs.body.append(radioplayer.services.analytics.$iframe)},sendEvent:function(a,b,c,e,d){radioplayer.services.analytics.loaded&&(radioplayer.utils.output("iframe loaded"),radioplayer.consts.consolelog&&console.dir($("#GAAnalytics")[0]),
$("#GAAnalytics")[0].contentWindow.postMessage(JSON.stringify({type:"Event",category:a,action:b,label:c,value:e,noninteraction:d}),"*"))},sendPageview:function(a){radioplayer.services.analytics.loaded&&$("#GAAnalytics")[0].contentWindow.postMessage(JSON.stringify({type:"Pageview",reason:a}),"*")},heartbeat:function(){radioplayer.services.analytics.loaded&&$("#GAAnalytics")[0].contentWindow.postMessage(JSON.stringify({type:"Heartbeat"}),"*")}},CrossDomain:{prototype:{_processData:function(a){radioplayer.stnList=
a;$(radioplayer.services).trigger("stationListSet")}}}};
...
radioplayer.lang={general:{radioplayer:"Radioplayer",open_menu:"Radioplayer Menü öffnen",close_menu:"Radioplayer Menü schließen",close_search:"Radioplayer Suche schließen",fail_message:"\x3ch1\x3eEs gibt ein Problem...\x3c/h1\x3e\x3cp\x3e\x3cstrong\x3eEntschuldigen\x3c/strong\x3e Sie die Störung. Bitte prüfen Sie zunächst Ihre Internetverbindung.\x3c/p\x3e\x3cp\x3eSollte das Problem bei uns liegen, dann arbeiten unsere Techniker schon daran. \x3cbr /\x3eBitte versuchen Sie es später nochmal.\x3c/p\x3e",
reduced_func_anno:'Mit diesem Browser können Sie leider nicht alle Funktionen des Radioplayers nutzen. \x3ca href\x3d"http://www.radioplayer.de/cookies/" target\x3d"_blank"\x3eÄndern Sie die Cookie-Einstellungen\x3c/a\x3e, oder \x3ca href\x3d"http://www.radioplayer.de/apps" target\x3d"_blank"\x3eladen Sie sich unsere kostenlose App.\x3c/a\x3e',cookie_anno:'Der Radioplayer verwendet Cookies, um alle Funktionen anbieten zu können.\x3cbr /\x3eWas Cookies sind und wie wir sie verwenden, können Sie \x3ca href\x3d"http://www.radioplayer.de/cookies/" target\x3d"_blank"\x3ehier nachlesen\x3c/a\x3e. Indem Sie den Radioplayer verwenden, erklären Sie sich mit der Nutzung von Cookies einverstanden.',
cookie_consent:'\x3cp\x3eDer Radioplayer verwendet und speichert Daten (aus Cookies und der IP-Adresse) zu Ihrem Hörverhalten, Ihren Favoriten und Ihrem Standort.\x3c/p\x3e\x3cp\x3eDiese Daten werden benötigt um Sender in der Nähe und Ihre Favoriten anzuzeigen, sowie um bessere Empfehlungen aussprechen zu können. Weitere Informationen hierzu erhalten Sie in unseren \x3ca target\x3d"_blank" href\x3d"https://www.radioplayer.de/impressum-datenschutz.html"\x3eDatenschutzbestimmungen\x3c/a\x3e.\x3c/p\x3e',
cookie_consent_dismiss:"Akzeptieren",apps_download:"Apps zum Download"},controls:{loading:"Laden...",player_controls:"Player Steuerung",play:"Play",pause:"Pause",stop:"Stopp",mute:"Stumm",unmute:"Stumm aus",set_volume:"Lautstärke",set_volume_20:"Lautstärke 20%",set_volume_40:"Lautstärke 40%",set_volume_60:"Lautstärke 60%",set_volume_80:"Lautstärke 80%",set_volume_100:"Lautstärke 100%",use_device_controls:"Bitte verwenden Sie den Lautstärkeregler an Ihrem Gerät.",press_play_prompt:"Zum Starten\x3cbr\x3ePlay drücken",
skip_forward_5_seconds:"5 Sekunden weiter springen",skip_back_5_seconds:"5 Sekunden zurück springen",skip_forward_30_seconds:"30 Sekunden weiter springen",skip_back_30_seconds:"30 Sekunden zurück springen",skip_forward_1_minute:"1 Minute weiter springen",skip_back_1_minute:"1 Minute zurück springen",skip_forward_5_minutes:"5 Minuten weiter springen",skip_back_5_minutes:"5 Minuten zurück springen",skip_forward_10_minutes:"10 Minuten weiter springen",skip_back_10_minutes:"10 Minuten zurück springen",
skip_forward_30_minutes:"30 Minuten weiter springen",skip_back_30_minutes:"30 Minuten zurück springen"},playing:{live:"Live",live_width:28,format:"{artist} - {track}"},songactions:{buy:"Kaufen",download:"Download",music:"Musik",info:"Information",add:"Hinzufügen",rate:"Bewerten",custom:"custom"},menu_tabs:{tab_1_text:"Meine Sender",tab_1_width:"187px",tab_2_text:"zuletzt gehört",tab_2_width:"187px",tab_3_text:"Empfohlen",tab_3_width:"187px",tab_4_text:"Sender A-Z",tab_4_width:"189px"},recommendations:{locale:"de_DE"},
azlist:{alphabet_array:"#abcdefghijklmnopqrstuvwxyz".split(""),no_stations_beginning:"Hier gibt es noch keine Sender, die mit {letter} beginnen",view_stations_beginning:"Sender anzeigen, die mit {letter} beginnen",a_number:"einer Zahl",no_stations:"Es gibt noch keinen Sender mit diesem Buchstaben"},mystations:{add_this:"Sender zu Meine Sender hinzufügen",remove_this:"Sender aus Meine Sender entfernen",no_items:"\x3ch1\x3eZu Meine Sender hinzufügen\x3c/h1\x3e\x3cp\x3eSie haben noch keine Sender gespeichert.\x3cbr /\x3eKlicken Sie auf das graue Herz bei Ihren Lieblingssendern, um sie hier zu speichern.\x3c/p\x3e"},
search:{search:"Suchen",clear:"Suchfeld löschen",search_radioplayer:"Sender finden",suggested_title:"Empfohlene Suchergebnisse",suggested_stations:"Empfohlene Sender",suggested_catch_up:"Empfohlene Podcasts",show_all_results_for:"Alle Ergebnisse zu {terms} anzeigen",tab_all:"Alle",tab_all_title:"Alle Suchergebnisse",tab_live:"Live",tab_live_title:"Gefundene Live-Programme",tab_catchup:"Podcasts",tab_catchup_title:"Gefundene Podcasts",show_fewer_stations:"Weniger {group} Sender anzeigen",show_more_stations:"Mehr {group} Sender anzeigen",
show_information:"Informationen anzeigen",hide_information:"Informationen ausblenden",no_all_results:'\x3ch1\x3eNichts gefunden\x3c/h1\x3e\x3cp\x3eWir konnten keine Sender oder Podcasts passend zu \x3cbr /\x3e\x3cspan class\x3d"terms"\x3e{terms}\x3c/span\x3e\x3cbr /\x3efinden.\x3c/p\x3e\x3cp\x3eBitte prüfen Sie Ihre Eingabe oder starten Sie eine neue Suche mit dem Namen eines \x3cstrong\x3eSenders\x3c/strong\x3e, eines \x3cstrong\x3eProgramms\x3c/strong\x3e, oder mit einem \x3cstrong\x3eOrt\x3c/strong\x3e.\x3c/p\x3e',
no_live_results:'\x3ch1\x3eNichts gefunden\x3c/h1\x3e\x3cp\x3eWir konnten keinen Sender passend zu \x3cbr /\x3e\x3cspan class\x3d"terms"\x3e{terms}\x3c/span\x3e\x3cbr /\x3efinden.\x3c/p\x3e\x3cp\x3eBitte prüfen Sie Ihre Eingabe oder starten Sie eine neue Suche mit dem Namen eines \x3cstrong\x3eSenders\x3c/strong\x3e, eines \x3cstrong\x3eProgramms\x3c/strong\x3e, oder mit einem \x3cstrong\x3eOrt\x3c/strong\x3e.\x3c/p\x3e',no_od_results:'\x3ch1\x3eNichts gefunden\x3c/h1\x3e\x3cp\x3eWir konnten keinen Podcast passend zu \x3cbr /\x3e\x3cspan class\x3d"terms"\x3e{terms}\x3c/span\x3e\x3cbr /\x3efinden.\x3c/p\x3e\x3cp\x3eBitte prüfen Sie Ihre Eingabe oder starten Sie eine neue Suche mit dem Namen eines \x3cstrong\x3eSenders\x3c/strong\x3e, eines \x3cstrong\x3eProgramms\x3c/strong\x3e, oder mit einem \x3cstrong\x3eOrt\x3c/strong\x3e.\x3c/p\x3e',
live:"Live",coming_up:"In Kürze",broadcast:"Podcast",in_seconds:"in Sekunden",in_minute:"in 1 Minute",in_minutes:"in {n} Minuten",second_ago:"vor 1 Sekunde",seconds_ago:"vor {n} Sekunden",minute_ago:"vor 1 Minute",minutes_ago:"vor {n} Minuten",hour_ago:"vor 1 Stunde",hours_ago:"vor {n} Stunden",day_ago:"vor 1 Tag",days_ago:"vor {n} Tagen",week_ago:"vor 1 Woche",weeks_ago:"vor {n} Wochen",month_ago:"vor 1 Monat",months_ago:"vor {n} Monaten",year_ago:"vor 1 Jahr",years_ago:"vor {n} Jahren"},stream_error:{unavailable:'\x3ch1\x3eLeider nur Stille\x3c/h1\x3e\x3cp\x3eWir versuchen den Sender zu starten, aber es funktioniert leider nicht.\x3c/p\x3e\x3cp\x3eEntweder ist der Webstream gerade nicht verfügbar oder er ist nicht mit Ihrem Gerät kompatibel.\x3c/p\x3e\x3cp\x3eGlücklicherweise gibt es einen anderen Weg, das Programm zu hören: \x3ca href\x3d"http://www.radioplayer.de/apps" target\x3d"_blank"\x3eLaden Sie sich unsere kostenlose Radioplayer-App\x3c/a\x3e auf Ihr Smartphone oder Tablet.\x3c/p\x3e',
device_incompatible:'\x3ch1\x3eLeider nur Stille\x3c/h1\x3e\x3cp\x3eWir versuchen den Sender zu starten, aber offenbar ist der Webstream nicht mit Ihrem Gerät kompatibel.\x3c/p\x3e\x3cp\x3eGlücklicherweise gibt es einen anderen Weg, das Programm zu hören: \x3ca href\x3d"http://www.radioplayer.de/apps" target\x3d"_blank"\x3eLaden Sie sich unsere kostenlose Radioplayer-App\x3c/a\x3e auf Ihr Smartphone oder Tablet.\x3c/p\x3e'}};